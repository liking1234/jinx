  ...
  <main ref="main">
    <section>
      ...
      <div class="image-slider">
        <div>
          <img src="~@/assets/img/imageContrastWidget/south-china-sea2015.jpg" alt="Before" />
        </div>
        <img src="~img/imageContrastWidget/south-china-sea2006.jpg" alt="After" />
      </div>
    </section>
    <section>
      <h5>2️⃣ Range-input control solution</h5>
      <div ref="slider" class="image-slider range">
        <img ref="sliderImg" src="~img/imageContrastWidget/south-china-sea2015.jpg" alt="Before" />
        <img src="~img/imageContrastWidget/south-china-sea2006.jpg" alt="After" />
      </div>
    </section>
  </main>
